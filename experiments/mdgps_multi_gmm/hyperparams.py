...
from gps.algorithm.policy_opt.tf_gmm_model import tf_gmm_network
from gps.algorithm.policy_opt.tf_vae_network import tf_vae_network
...
EXP_DIR = BASE_DIR + '/../experiments/mdgps_multi_gmm/'
...
agent = {
    'type': AgentMuJoCo,
    'filename': './mjc_models/pr2_arm3d_4holes.xml',
...
fk_cost = {
    'type': CostFK,
    'target_end_effector': np.array([[-0.174, 0.185, -0.5, -0.174, 0.185, -0.2],
                                    [0.174, 0.185, -0.5, 0.174, 0.185, -0.2],
                                    [0.174, 0.415, -0.5, 0.174, 0.415, -0.2],
                                    [-0.174, 0.415, -0.5, -0.174, 0.415, -0.2]]),
